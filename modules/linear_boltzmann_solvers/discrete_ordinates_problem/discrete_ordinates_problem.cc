    ...
    for (const auto& dir_ss_info : dir_subsets)
    {
      ...
      else if (sweep_type_ == "CBC")
      {
        ...
        else
        {
          ...
          local_psi_bytes =
            cbc_common_data.GetTotalLocalFaceSlotNodes() * num_groups_and_angles * sizeof(double);
          incoming_nonlocal_bytes = cbc_common_data.GetTotalIncomingNonlocalFaceNodes() *
