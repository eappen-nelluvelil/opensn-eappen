...
//   if (num_tasks == 0)
//   {
//     max_num_pool_allocator_slots_ = 0;
//     return;
//   }

//   // Use on-the-fly Hopcroft-Karp matching (no reachability matrix)
//   ImplicitHopcroftKarp matcher(num_tasks, task_list_);
//   size_t matching_size = matcher.Solve();

//   // N - |M| is a provably safe upper bound on the number of simultaneously
//   // allocated pool allocator slots under any valid execution ordering.
//   max_num_pool_allocator_slots_ = num_tasks - matching_size;
// }
