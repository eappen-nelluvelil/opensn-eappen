 ...
 * consumed only by the cycle-aware kernel specialization `SweepKernel<SweepType::CBC, true>`.
 * The acyclic specialization `SweepKernel<SweepType::CBC, false>` never inspects bit 60, so
