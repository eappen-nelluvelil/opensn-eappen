...
{
  // Size each incoming-nonlocal face slot from CommonData's face nodal mapping, which already
  // owns the per-face node count derived from the spatial discretization at setup time.
