...
public:
  ...
  /// Get the previous-time angular-flux device pointer.
  const double* GetPsiOldDevicePointer() const { return device_psi_old_.get(); }
...
private:
  ...
  /// Device and host storage for previous-time psi.
