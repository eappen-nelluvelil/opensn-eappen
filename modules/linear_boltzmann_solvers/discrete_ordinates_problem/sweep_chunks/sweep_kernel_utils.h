...
/// SIMD width for double-precision vectorization.
...
/// Compute the group block size for SIMD-friendly group blocking.
inline size_t
...
/// SIMD batch solve: solves simd_width independent NxN linear systems simultaneously.
/// b layout: b[group * N + node], sigma_t layout: sigma_t[group].
/// Am and Mm are flat NxN arrays (streaming matrix and mass matrix).
template <class Ops, int N>
