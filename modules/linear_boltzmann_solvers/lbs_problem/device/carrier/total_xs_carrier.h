 ...
 *
 * Group-wise total cross sections for all block IDs are stored first, and then
 * followed by group-wise inverse velocities for all block IDs.
 * The constructor initializes a map to record the stride associated with each
 * block ID.
 */
